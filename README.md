...
* 5. For more info about PK3C advantages comparing with PCC , see top comments of the [a relative link](tcp_pk3c_main.c) (and the main advantage is that slow-start happens much faster for PK3C, than for PCC, and two years of science were for making this solution,
